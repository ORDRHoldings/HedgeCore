  ...
  sections: [
    ...
    },
    {
      ...
      variables: [
        ...
        { name: "entity",       type: "STRING",        description: "REQUIRED. Legal entity or business unit. Must match your company structure. Used for consolidation and reporting. Examples: division, subsidiary, cost center.", example: "Acme LATAM or Treasury US", source: "ORDR schema" },
