...
export const DASHBOARD_HELP: ModuleHelp = {
  ...
  sections: [
    ...
    },
    {
      ...
      callout: {
        type: "regulatory",
        text: "Market data sourced from Finnhub and Yahoo Finance is indicative only. ORDR Terminal does not provide executable quotes. All rates used in hedge calculations must be confirmed with the executing counterparty before submission.",
      },
      content:
