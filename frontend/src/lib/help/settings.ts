...
export const SETTINGS_HELP: ModuleHelp = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        "**90-Day Rotation Policy**: Industry standards (NIST SP 800-57, CIS Controls 4.4) recommend rotating long-lived API credentials at least every 90 days. The ORDR Terminal's zero-downtime rotation procedure (generate → deploy → verify → revoke) supports this without service interruption. Set a calendar reminder or automate rotation via CI/CD pipeline.\n\n" +
