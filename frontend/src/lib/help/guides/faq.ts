...
export const FAQ: GuideDoc = {
  ...
  title: "FAQ",
  summary:
    "Frequently asked questions about ORDR Terminal: pipeline states, data quality indicators, governance controls, hedge math, and operational procedures.",
  path: "/faq",
  icon: "?",
