 ...
 * Four-act narrative: hero → KPIs → charts → findings → trust → CTA.
...
export default function AuditLabDemoPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: S.bgDeep, fontFamily: S.fontUI }}>
      ...
      {/* Nav strip */}
      <div style={{
        borderBottom: `1px solid ${S.soft}`, padding: "12px 40px",
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "48px 40px" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{
            ...
            letterSpacing: "0.12em", color: S.cyan, marginBottom: 12,
          }}>
          ...
          <p style={{ fontFamily: S.fontUI, fontSize: 15, color: S.secondary, margin: 0, maxWidth: 600, lineHeight: 1.7 }}>
            Sample Corporation paid{" "}
            <strong style={{ color: S.red }}>{fmt(ar.totalCostUsd)}</strong>{" "}
            in avoidable FX costs last quarter.
        ...
        <div style={{
          ...
          background: S.rim, border: `1px solid ${S.rim}`,
          marginBottom: 40, borderRadius: 3, overflow: "hidden",
        }}>
          {([
            ...
            <div key={k.label} style={{ background: S.bgPanel, padding: "18px 20px" }}>
              <div style={{
                ...
                letterSpacing: "0.1em", color: S.tertiary, textTransform: "uppercase", marginBottom: 6,
              }}>{k.label}</div>
              <div style={{ fontFamily: S.fontMono, fontSize: 22, fontWeight: 700, color: k.color, letterSpacing: "-0.02em" }}>
                {k.value}
              </div>
        ...
        {/* Act 3: Markup by month chart */}
        <div style={{ marginBottom: 40 }}>
          <div style={{
            fontFamily: S.fontMono, fontSize: 11, fontWeight: 700,
            letterSpacing: "0.12em", color: S.tertiary, textTransform: "uppercase", marginBottom: 16,
          }}>
            MARKUP COST BY MONTH
          </div>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontFamily: S.fontUI, fontSize: 13, color: S.secondary, lineHeight: 1.6 }}>
                ...
                {Math.round(worst.avgBps / best.avgBps)}x higher than{" "}
          ...
          <div style={{
            fontFamily: S.fontMono, fontSize: 11, fontWeight: 700,
            letterSpacing: "0.12em", color: S.tertiary, textTransform: "uppercase", marginBottom: 12,
          }}>
            ...
            {d.findings.map(f => (
              <div key={f.id} style={{ background: S.bgPanel, border: `1px solid ${S.rim}`, padding: "16px 20px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8, flexWrap: "wrap" }}>
                  ...
                  <span style={{
                    fontFamily: S.fontMono, fontSize: 12, fontWeight: 700,
                    letterSpacing: "0.08em", color: S.cyan,
                  }}>
                    {f.finding_type.replace(/_/g, " ")}
                  </span>
                  {f.currency_pair && (
                    <span style={{ fontFamily: S.fontMono, fontSize: 12, color: S.tertiary }}>{f.currency_pair}</span>
                  )}
                  {f.counterparty && (
                    <span style={{ fontFamily: S.fontMono, fontSize: 12, color: S.tertiary }}>· {f.counterparty}</span>
                  )}
                  <span style={{
                    marginLeft: "auto", fontFamily: S.fontMono,
                    fontSize: 13, fontWeight: 700, color: S.red,
                  }}>
                    {fmt(f.amount_usd)}
                  </span>
                </div>
          ...
          {d.trustSignals.map((sig, i) => {
            ...
            return (
              <div key={sig.label} style={{
                ...
                <div>
                  <div style={{ fontFamily: S.fontMono, fontSize: 12, fontWeight: 700, color: S.primary, marginBottom: 3 }}>
                    {sig.label}
                  </div>
                  <div style={{ fontFamily: S.fontUI, fontSize: 12, color: S.tertiary, lineHeight: 1.55 }}>
                    {sig.detail}
                  </div>
                </div>
              </div>
        ...
        <div style={{ background: S.bgPanel, border: `1px solid ${S.rim}`, padding: "36px 40px", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: S.fontUI, fontSize: 14, color: S.secondary, maxWidth: 480, margin: "0 auto 28px", lineHeight: 1.65 }}>
            ...
            who charged the most, and what you could recover — with a tamper-evident evidence binder
        ...
        <div style={{ marginTop: 24, fontFamily: S.fontUI, fontSize: 11, color: S.tertiary, lineHeight: 1.6, textAlign: "center" }}>
          DISCLAIMER: All figures shown use static sample data. Rate variance figures are reference-baseline
          analytical what-ifs, not factual loss claims. Markup and fee figures reflect computed transaction
          costs vs. market benchmark rates.
        </div>
