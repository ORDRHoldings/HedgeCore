...
function ExecutionProposalsPanel({ token }: { token: string }) {
  ...
  // suppress unused warning — router is used for navigation in parent context
  void router;
...
export default function StagingListPage() {
  ...
  return (
    <PageShell icon={Globe} title="Staging Queue" breadcrumb={["Governance", "Staging"]} noPadding>
