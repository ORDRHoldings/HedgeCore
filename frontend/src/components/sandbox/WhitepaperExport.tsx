...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .meta { font-family: 'Courier New', monospace; font-size: 12px; color: #94a3b8; margin-bottom: 32px; }
    ...
    .kpi-label { font-size: 12px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: #64748b; margin-top: 4px; }
    table { width: 100%; border-collapse: collapse; font-size: 12px; margin: 16px 0; }
    th { background: #f1f5f9; padding: 8px 10px; text-align: left; font-weight: 700; font-size: 12px; letter-spacing: 0.08em; text-transform: uppercase; color: #475569; border-bottom: 2px solid #cbd5e1; }
    ...
    .ref { font-size: 12px; color: #64748b; margin: 6px 0; padding-left: 16px; }
    .page-break { page-break-before: always; }
    .badge { display: inline-block; padding: 2px 8px; border-radius: 4px; font-size: 12px; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; margin-left: 8px; }
...
<body>
  ...
  <div style="border-bottom: 3px solid #0f172a; padding-bottom: 24px; margin-bottom: 24px;">
    <div style="font-family: monospace; font-size: 12px; font-weight: 700; letter-spacing: 0.15em; color: #3b82f6; text-transform: uppercase; margin-bottom: 10px;">
  ...
  <p>
    The HedgeCore ORDR Treasury provides an end-to-end FX hedge simulation, risk quantification, and execution management platform
  ...
  <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e2e8f0; font-size: 12px; color: #94a3b8;">
    <strong>DISCLAIMER:</strong> This document is generated by the HedgeCore ORDR Treasury simulation engine.
  ...
  return (
    <div style={{ background: S.panel, border: `1px solid ${S.rim}`, borderRadius: 4, overflow: "hidden" }}>
      ...
      <div style={{ padding: "14px 16px" }}>
        ...
        <div style={{ fontFamily: S.fontMono, fontSize: 12, fontWeight: 700, color: S.tertiary, letterSpacing: "0.08em", marginBottom: 10 }}>
          WHITEPAPER CONTENTS
        </div>
        {[
          ...
          <div key={num as string} style={{ display: "flex", gap: 12, padding: "5px 0", borderBottom: `1px solid ${S.soft}` }}>
            <span style={{ fontFamily: S.fontMono, fontSize: 12, fontWeight: 700, color: S.cyan, minWidth: 24 }}>{num}</span>
        ...
        <div style={{ marginTop: 16, display: "flex", gap: 12 }}>
          <div style={{
            ...
            <div style={{ fontFamily: S.fontMono, fontSize: 12, fontWeight: 700, color: S.cyan, marginBottom: 4 }}>EXPORT FORMAT</div>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: S.fontMono, fontSize: 12, fontWeight: 700, color: S.green, marginBottom: 4 }}>LIVE DATA EMBEDDED</div>
            <div style={{ fontFamily: S.fontUI, fontSize: 12, color: S.secondary }}>
              {sandboxResult
        ...
        <div style={{ marginTop: 12, fontFamily: S.fontMono, fontSize: 12, color: S.tertiary }}>
