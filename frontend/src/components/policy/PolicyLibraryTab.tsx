...
/**
 * PolicyLibraryTab — Policy Library (tab component)
 *
 * Extracted from /policies for use in the unified tabbed layout.
 * System preset policies, activation, compare, favorites, detail drawers.
 */
...
// ── Main page component ───────────────────────────────────────────────────────
export default function PolicyLibraryTab() {
  const { token } = useAuth();
