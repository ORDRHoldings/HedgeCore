...
| R-006 | Regulatory reporting exports | HIGH | 2026-03-06 | RESOLVED | EMIR Article 9 XML, MiFID II RTS 25 XML, and Dodd-Frank Title VII pipe-delimited exports implemented. 3 API endpoints (GET /v1/reports/{run_id}/emir, /mifid, /dodd-frank). 59 tests passing. Format-complete, schema-unvalidated against live regulatory repositories. |
