...
- **Status**: Mitigated (advisory). Workflow verified production-parity locally; first real CI run pending billing restoration will show the documented 66P/83F/5E shape. Hard-gate promotion is now a definable test-fixing arc, not an opaque "wait and see."
