...
# Report fingerprinting (computeReportHash / buildReportHTML / TestEnhancedReportHash)
# was deleted 2026-04-26: the helpers were never wired into the real export path
# (ExportBar.handlePdf delegates to @/utils/clientExport which carries the engine
# RunEnvelope hashes natively). The contract tests only proved string presence
# in source, not behavior. Restoring fingerprinting in the UI layer is tracked as
# a v1.5 backlog item — see CHANGELOG_AI 2026-04-26 and the OpenAPI audit doc.
