...
class APIKeyAuthMiddleware(BaseHTTPMiddleware):
    """
    Canonical API-key middleware (v2).

    FIX:
    - Correct prefix matching for double-mounted /api routers
    - Clean bootstrap handling
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.public_prefixes = (
            ...
            # 🔓 ADMIN BOOTSTRAP (MATCH CURRENT ROUTER STRUCTURE)
