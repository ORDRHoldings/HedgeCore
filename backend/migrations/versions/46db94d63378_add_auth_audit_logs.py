...
def upgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_refresh_tokens_replaced_by_jti")
    op.execute("DROP INDEX IF EXISTS ix_refresh_tokens_user_revoked")
    op.execute("DROP INDEX IF EXISTS ux_refresh_tokens_jti")
    op.execute("DROP TABLE IF EXISTS refresh_tokens CASCADE")
    op.execute("DROP INDEX IF EXISTS ix_audit_logs_path")
    op.execute("DROP INDEX IF EXISTS ix_audit_logs_reqid")
